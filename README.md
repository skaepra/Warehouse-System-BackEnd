...
عند إنشاء قاعدة البيانات لأول مرة، يقوم النظام تلقائياً بإنشاء حساب **Manager** لاستخدامه في تسجيل الدخول وتجربة النظام.
...
> 💡 حساب الـManager ضروري للبدء، لأن إنشاء حسابات الموظفين يتم من خلال المستخدم الذي يمتلك صلاحية **Manager**.

بعد تسجيل الدخول بحساب المدير، يمكنك إنشاء حسابات الموظفين بالأدوار المتاحة في النظام.
...
بعد تشغيل المشروع سيظهر عنوان الـAPI في الـTerminal، مثل:
